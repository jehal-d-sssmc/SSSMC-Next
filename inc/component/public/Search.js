...
export default class Search extends React.Component {
    ...
    searchdata = async (s, type = '') => {
        ...
        let qry = {
            default: ["title", "category", "description"].map((t)=>{
                return queryBuilder(t)
            }),
            article: ["title", "category", "customTemplate"].map((t)=>{
                return queryBuilder(t)
            }),
            audio: ["title", "category", "description","meaning","lyrics","grouping","artiste","album_name"].map((t)=>{
                return queryBuilder(t)
            }),
        }
        console.log(query, s);
    ...
    async componentDidMount(){
        ...
        await this.searchdata(this.search, type)
    }
                            ...
                            }
                            {
                                ...
                                <>
                                    <div>
                                        ...
                                        <span 
                                        onClick={() => {
                                            this.props.redirect("/listen" + `?q=${encodeURIComponent(this.props.state.search.text)}${this.props.state.search.type !== undefined && this.props.state.search.type !== "" ? "&o=" + encodeURIComponent(this.props.state.search.type) : ""}`);
                                            this.forceUpdate();
                                        }}
                                        className="text-danger"
                                        >
